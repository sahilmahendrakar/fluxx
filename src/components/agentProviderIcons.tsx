/**
 * Provider marks for compact agent UI. Anthropic and OpenAI paths are from
 * Simple Icons (MIT): https://github.com/simple-icons/simple-icons — same
 * attribution pattern as `openWorkspaceTargetIcons.tsx`.
 */
import type { Agent } from '../types';
import { CursorBrandIcon } from './openWorkspaceTargetIcons';

/** GitHub mark (Simple Icons, MIT) for CLI / PR UI. */
