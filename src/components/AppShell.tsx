      ...
      <main className="relative flex min-h-0 flex-1 flex flex-col overflow-hidden">
        {collapsed ? (
          <button
            ...
            className="absolute left-2 top-2 z-30 rounded-md border border-flux-line bg-flux-elevated/90 p-1 text-flux-muted shadow-sm backdrop-blur transition hover:bg-flux-tint/5 hover:text-flux-fg-soft"
          >
            <SidebarExpandIcon />
          </button>
        ) : null}
